    ...
    def hashCheck(args, languages, langue):
        ...
        if local_hash != remote_hash:
            ...
            if reponse in ["yes", "oui"]:
                subprocess.run(["git", "reset", "--hard"]) # Prevoie le cas ou les utilisateur aurais fait des modification au code affin de ne pas avoir de soucis
                subprocess.run(["git", "pull", "origin", "main"]) # Rapatrie la dernière version du code
